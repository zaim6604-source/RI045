    ...
    <footer className="bg-[#0d1f35] text-white py-12 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-10 items-start pb-10 border-b border-white/10">
          ...
          {/* Left: brand */}
          <div>
            <p className="font-playfair font-bold text-2xl tracking-wide mb-1">
              Rawal International
            </p>

            <p className="text-[#c9a84c] text-xs tracking-[0.25em] uppercase mb-5">
              Overseas Employment Promoter
            </p>

            <p className="text-white/50 text-sm leading-relaxed max-w-sm">
              Licensed overseas employment agency helping skilled Pakistani
              professionals connect with international career opportunities.
            </p>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-white/30 text-xs">
            &copy; {year} Rawal International. All rights reserved.
          </p>
