    ...
    >
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
        ...
        <a href="#top" className="flex flex-col leading-none group">
          ...
          <span
            className="text-xs tracking-[0.18em] uppercase transition-colors duration-300 text-[#c9a84c]"
          >
            Overseas Employment
          </span>
        </a>
        ...
        <ul className="hidden md:flex items-center gap-8">
          ...
          <li>
            <a
              href="#contact"
              className="bg-[#1e3a5f] text-white text-sm font-medium px-5 py-2 rounded-full hover:bg-[#c9a84c] hover:text-[#1a1a2e] transition-colors duration-300"
            >
              Get Started
            </a>
          </li>
        ...
        <ul className="flex flex-col gap-2 px-6">
          ...
          <li className="pt-2">
            <a
              href="#contact"
              onClick={() => setOpen(false)}
              className="block text-center bg-[#1e3a5f] text-white text-sm font-medium px-5 py-2 rounded-full hover:bg-[#c9a84c] hover:text-[#1a1a2e] transition-colors duration-300"
            >
              Contact Us
            </a>
          </li>
