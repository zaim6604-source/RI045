...
export default function ContactSection() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      window.open(`https://wa.me/923332145939?text=${text}`, '_blank');
    }, 600);
  };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-start">
          ...
          <div className="reveal space-y-10">
            <div>
              <p className="text-xs font-semibold tracking-[0.2em] uppercase text-[#9ca3af] mb-3">Address</p>
            ...
            <div>
              <p className="text-xs font-semibold tracking-[0.2em] uppercase text-[#9ca3af] mb-3">Phone</p>
              <div className="flex flex-col gap-2">
                {['021-34122090', '0333-2145939'].map((ph) => (
                  ...
                  >
                    ...
                    <span className="text-[#374151] text-sm group-hover:text-[#1e3a5f] transition-colors">{ph}</span>
                  </a>
                ))}
              </div>
            </div>
            ...
            <div className="bg-[#f8f6f1] rounded-2xl p-6">
              <p className="font-playfair font-semibold text-[#1e3a5f] text-lg mb-2">Working Hours</p>
          ...
          <div className="reveal reveal-delay-2">
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-16 text-center gap-5">
                ...
                <p className="font-playfair text-2xl font-semibold text-[#1e3a5f]">Message Sent!</p>
                <p className="text-[#6b7280] text-sm">Redirecting you to WhatsApp…</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-8" noValidate>
                {field('name', 'Full Name', 'text', 'Your full name')}
                {field('phone', 'Phone Number', 'tel', '+92 300 0000000')}
                {field('job', 'Job Interest', 'text', 'e.g. Driver, Electrician, Carpenter…')}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full bg-transparent border-b py-2.5 text-[#1e3a5f] placeholder-[#9ca3af] text-sm outline-none resize-none transition-colors duration-300 focus:border-[#1e3a5f] ${
                      errors.message ? 'border-red-400' : 'border-[#d1cfc8]'
                    }`}
                  />
